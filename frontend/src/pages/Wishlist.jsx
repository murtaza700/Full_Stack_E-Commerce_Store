...
const Wishlist = () => {
        ...
        return (
            <>
                <Meta
                    ...
                    description="Synchronize your personal fragrance selections across all devices. Please authenticate to open your private luxury boutique tracking registers."
                    keywords="access wishlist, login boutique, secure vault scent profile"
                />
        ...
        return (
            <>
                <Meta
                    ...
                    description="Your private fragrance selection folder is currently clear. Browse the Scentsô boutique to build your custom formulas collection."
                />
    ...
    return (
        <>
            <Meta
                title="Your Private Wishlist Vault"
                description="Review your curated collection of bespoke artisan fragrances, high-fidelity signature ouds, and premium formulas reserved under your luxury profile."
                keywords="my favorites perfumes, private scents checklist, personal fragrance registry logs, saved formulas"
            />
