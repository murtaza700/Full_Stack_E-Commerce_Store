...
const ShopCatalog = () => {
    ...
    return (
        <>
            <Meta
                title="Explore Artisan Formulations & Collections"
                description="Browse the complete Scentsô catalogue. Filter through premium signature ouds, delicate floral extractions, and bespoke luxury colognes custom-crafted for exquisite profiles."
                keywords="buy luxury perfumes online, premium fragrance collection, artisan colognes catalog, boutique scent profiles, buy signature ouds"
            />
