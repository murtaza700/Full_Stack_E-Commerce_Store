...
const ShoppingCart = () => {
        ...
        return (
            <>
                <Meta
                    ...
                    description="Access your personalized Scentsô profile dashboard, secure checkout tracking vault, persistent wishlists registries, and private luxury transaction logs."
                />
    ...
    if (cartLoading?.fetchAll && cartItems.length === 0) {
        return (
            <>
                <Meta
                    title="Loading Your Shopping Bag"
                    description="Synchronizing secure luxury boutique cart assets with database cluster entries registry nodes."
                />
        ...
        return (
            <>
                <Meta
                    ...
                    description="Your luxury boutique selection is currently clear. Discover premium signature ouds, custom colognes, and artisan fragrance ranges inside our storefront."
                />
    ...
    return (
        <>
            <Meta
                ...
                description={`Review your itemized premium fragrance selections. Securely manage your artisan perfume formulations, quantities, and proceed to your private checkout corridor.`}
            />
