    ...
    return (
        <>
            <Meta
                ...
                description="Join the inner circle of Scentsô. Register your member profile today to unlock priority access to limited boutique extractions, curated perfume wishlists, and tailored private gifting services."
                keywords="create perfume account, join fragrance boutique, boutique member signup, exclusive perfume community registration"
            />
